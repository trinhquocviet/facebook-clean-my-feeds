...
export class NewsFeedSection extends BaseConfigSection {
...
const htmlTag = 'news-feed-section';
customElements.define(htmlTag, NewsFeedSection);
export { htmlTag as newsFeedSectionTag };
