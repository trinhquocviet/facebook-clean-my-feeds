...
export class CustomisationsSection extends BaseConfigSection {
...
const htmlTag = 'customisations-section';
customElements.define(htmlTag, CustomisationsSection);
export { htmlTag as customisationsSectionTag };
